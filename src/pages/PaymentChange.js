...
const PaymentChange = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        'https://shukra-nodejs-server.onrender.com/api/v1/paymentmethod/paymentconfig',
        formData
      );
  ...
  const handleOptionSubmit = async (value) => {
    try {
      ...
      await axios.post(
        'https://shukra-nodejs-server.onrender.com/api/v1/paymentmethod/updatestatus',
        {
  ...
  const fetchPaymentOptions = async () => {
    try {
      const response = await axios.get(
        'https://shukra-nodejs-server.onrender.com/api/v1/paymentmethod/paymentoptions'
      );
