...
const Subcategories = () => {
  ...
  const fetchData = async () => {
    try {
      const response = await axios.get(
        'https://shukra-nodejs-server.onrender.com/api/v1/product/cat'
      );

      const categoriesWithSubcategories = await Promise.all(
        response.data.map(async (category) => {
          const subcategoriesURL = `https://shukra-nodejs-server.onrender.com/api/v1/subcategories/subcategories/category/${category._id}`;
  ...
  const handleDeleteSubcategory = async (subcategoryId) => {
    try {
      await axios.delete(
        `https://shukra-nodejs-server.onrender.com/api/v1/subcategories/subcategories/delete/${subcategoryId}`
      );
  ...
  const handleCreateSubcategory = async () => {
    try {
      ...
      const response = await axios.post(
        `https://shukra-nodejs-server.onrender.com/api/v1/subcategories/createsubcategories`,
        {
  ...
  const handleUpdateSubcategory = async () => {
    try {
      await axios.put(
        `https://shukra-nodejs-server.onrender.com/api/v1/subcategories/subcategories/update/${selectedSubcategoryId}`,
        {
